...
export default class SceneFWA {
    ...
    setModels() {
        ...
        // this.parent.rotation.set(Math.PI / 2, 0, 0)
        this.scene.add(this.parent)

        this.fwa = this.gl.assets.models.scene.scene.getObjectByName('fwa').clone()
        this.fwa.material = this.glassMaterial
        // this.fwa.position.set(-0.25, 0, 0)
        this.fwa.rotation.set(Math.PI / 2.5, 0, 0)
        this.parent.add(this.fwa)
    }
    ...
    update() {
        ...
        /* 
          Fresnel
        */
        this.glassMaterial.uniforms.tFluidCursor.value = this.gl.world.fluidCursor.sourceTarget.texture
